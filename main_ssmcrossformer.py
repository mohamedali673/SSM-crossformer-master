...
parser = argparse.ArgumentParser(description='SSMCrossFormer')

parser.add_argument('--data', type=str, required=True, default='ETTm1', help='data')
parser.add_argument('--root_path', type=str, default='/SSM-crossformer-master/data/', help='root path of the data file')
...
data_parser = {
    ...
    'WTH':{'data':'WTH.csv', 'data_dim':21, 'split':[28*30*24, 10*30*24, 10*30*24]},
...
for ii in range(args.itr):
    ...
    setting = 'SSMCrossformer_{}_il{}_ol{}_sl{}_win{}_fa{}_dm{}_nh{}_el{}_itr{}'.format(args.data, 
